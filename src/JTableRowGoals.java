...
public class JTableRowGoals {
    ...
    public static void showGoalsDialog(JFrame parentFrame) {
        JDialog goalsDia = new JDialog(parentFrame, "Goals", true);
        goalsDia.setSize(1000, 700);
        goalsDia.setLayout(null);
        goalsDia.setLocationRelativeTo(parentFrame);
        ...
        JButton backGoalsBtn = new JButton("Back");
        backGoalsBtn.setBounds(450, 600, 100, 50);
        backGoalsBtn.setBackground(Color.decode("#FF914D"));
        backGoalsBtn.setBorder(new LineBorder(Color.decode("#FF914D")));
        backGoalsBtn.setFont(new Font("Arial", Font.PLAIN, 20));
        goalsDia.add(backGoalsBtn);
        backGoalsBtn.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                goalsDia.dispose();
            }
