...
public class JTableRowExpense {
    ...
    public static void showExpenseDialog(JFrame parentFrame) {
        JDialog expenseDia = new JDialog(parentFrame, "Expense", true);
        expenseDia.setSize(1000, 700);
        ...
        backExpBtn.setBounds(450, 600, 100, 50);
        ...
        tablePanel.setBounds(200, 100, 750, 500); // Adjusted size
